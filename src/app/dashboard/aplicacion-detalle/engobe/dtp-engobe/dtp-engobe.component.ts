...
@Component({
  selector: 'app-dtp-engobe',
  templateUrl: './dtp-engobe.component.html',
  styleUrls: ['./dtp-engobe.component.css']
})
export class DtpEngobeComponent implements OnInit {
...
reporte(){
  ...
  let val_dtp2 = this.conver_val_dtp2();
    ...
    if(dtp1.touched == false && dtp2.touched == false){
      window.open('http://localhost/PDG/server/pdf/aplicacion/engobe/reporte dia/reporte.php');
    }
    else 
    {
      if(dtp1.touched != false && dtp2.touched != false){
        window.open('http://localhost/PDG/server/pdf/aplicacion/engobe/reporte entre fechas/reporte.php?fecha1='+val_dtp1+'&fecha2='+val_dtp2);
      }
      else
      {
        if(dtp1.touched == false)
        {  
        window.open('http://localhost/PDG/server/pdf/aplicacion/engobe/reporte una fecha/reporte.php?fecha='+val_dtp2);
        }
        if(dtp2.touched == false)
        {  
        window.open('http://localhost/PDG/server/pdf/aplicacion/engobe/reporte una fecha/reporte.php?fecha='+val_dtp1);
        }
      }
