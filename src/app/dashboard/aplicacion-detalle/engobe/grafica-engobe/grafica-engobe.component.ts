...
@Component({
  selector: 'app-grafica-engobe',
  templateUrl: './grafica-engobe.component.html',
  styleUrls: ['./grafica-engobe.component.css']
})
export class GraficaEngobeComponent implements OnInit {
