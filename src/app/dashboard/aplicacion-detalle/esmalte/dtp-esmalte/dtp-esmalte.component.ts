...
@Component({
  selector: 'app-dtp-esmalte',
  templateUrl: './dtp-esmalte.component.html',
  styleUrls: ['./dtp-esmalte.component.css']
})
export class DtpEsmalteComponent implements OnInit {
...
reporte(){
  ...
  let val_dtp2 = this.conver_val_dtp2();
    ...
    if(dtp1.touched == false && dtp2.touched == false){
      window.open('http://localhost/PDG/server/pdf/aplicacion/esmalte/reporte dia/reporte.php');
    }
    else 
    {
      if(dtp1.touched != false && dtp2.touched != false){
        window.open('http://localhost/PDG/server/pdf/aplicacion/esmalte/reporte entre fechas/reporte.php?fecha1='+val_dtp1+'&fecha2='+val_dtp2);
      }
      else
      {
        if(dtp1.touched == false)
        {  
        window.open('http://localhost/PDG/server/pdf/aplicacion/esmalte/reporte una fecha/reporte.php?fecha='+val_dtp2);
        }
        if(dtp2.touched == false)
        {  
        window.open('http://localhost/PDG/server/pdf/aplicacion/esmalte/reporte una fecha/reporte.php?fecha='+val_dtp1);
        }
      }
